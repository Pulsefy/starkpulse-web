...
class CoinMarketCapClient(APIClient):
    ...
    async def get_listings(self, start: int = 1, limit: int = 100) -> Dict[str, Any]:
        ...
        return await self.get(
            "cryptocurrency/listings/latest", params=params, headers=headers
        )
    ...
    async def get_quotes(self, symbols: List[str]) -> Dict[str, Any]:
        ...
        return await self.get(
            "cryptocurrency/quotes/latest", params=params, headers=headers
        )
...
class CryptoPanicApiClinet(APIClient):
    """
    ...
    def __init__(self, settings: Settings):
        super().__init__(f"https://cryptopanic.com/api/{settings.coingecko_api_plan}/v2/posts/")
        self.api_key = settings.cryptopanic_api_key

    async def get_news(self, query: str = None, page: int = 1, to_data: str =None, currency: str = None) -> Dict[str, Any]:
